...
6. How to get nodes containing cycle (Got issue here thought depth first search will work but because of adjacency matrix way it can happen that the edge can be `1->2`, `2->3`, `1->4` then `1->3` which is actually not a cycle but because of the visited logic you might consider it to be the case).
7. A good resource to recap graphs: https://leetcode.com/discuss/post/8396904/5-graph-patterns-that-solve-90-of-leetco-cnkw/